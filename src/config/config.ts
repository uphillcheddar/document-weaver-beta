export const brandName = "Document Weaver";
export const landingPageTitle = "Document Weaver";
export const landingPageDescription = "Generate Programmatic Documents With Ease";
export const websiteUrl = "http://localhost:3000";
export const supportEmail = "support@documentweaver.com";
